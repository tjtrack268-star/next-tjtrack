...
export default function PromotionsPage() {
  ...
  const carouselProducts = promotionProducts.slice(0, 5)
          ...
          <div className="relative h-48 sm:h-56">
            ...
            >
              {carouselProducts.map((product, index) => (
                <div 
                  key={index} 
                  className="w-full flex-shrink-0 relative bg-gradient-to-r from-destructive to-destructive/80 cursor-pointer"
                ...
                >
                  ...
                  <div className="relative z-10 p-6 h-full flex flex-col justify-center">
                    <Badge className="bg-white/20 text-white mb-2 w-fit">Promotion</Badge>
